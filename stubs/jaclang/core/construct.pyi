...
class EdgeAnchor(ObjectAnchor):
    ...
    def spawn_call(self, walk: WalkerArchitype) -> WalkerArchitype: ...
    def __init__(
        self, obj, id, source, target, source_id, target_id, is_undirected, persistent
    ) -> None: ...
...
class WalkerAnchor(ObjectAnchor):
    ...
    disengaged: bool = ...
    def visit_node(
        self, nds: list[NodeArchitype | EdgeArchitype] | NodeArchitype | EdgeArchitype
    ) -> bool: ...
    def ignore_node(
        self, nds: list[NodeArchitype | EdgeArchitype] | NodeArchitype | EdgeArchitype
    ) -> bool: ...
...
class JacTestResult(unittest.TextTestResult):
    ...
    def __init__(
        self, stream, descriptions, verbosity: int, max_failures: Optional[int] = None
    ) -> None: ...
