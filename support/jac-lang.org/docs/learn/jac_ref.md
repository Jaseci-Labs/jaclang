...
**Grammar Snippet**
```yaml linenums="117"
--8<-- "jaclang/compiler/jac.lark:117:143"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="146"
--8<-- "jaclang/compiler/jac.lark:146:148"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="151"
--8<-- "jaclang/compiler/jac.lark:151:151"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="154"
--8<-- "jaclang/compiler/jac.lark:154:155"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="158"
--8<-- "jaclang/compiler/jac.lark:158:161"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="164"
--8<-- "jaclang/compiler/jac.lark:164:165"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="168"
--8<-- "jaclang/compiler/jac.lark:168:178"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="181"
--8<-- "jaclang/compiler/jac.lark:181:181"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="190"
--8<-- "jaclang/compiler/jac.lark:190:191"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="199"
--8<-- "jaclang/compiler/jac.lark:199:203"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="211"
--8<-- "jaclang/compiler/jac.lark:211:213"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="216"
--8<-- "jaclang/compiler/jac.lark:216:216"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="222"
--8<-- "jaclang/compiler/jac.lark:222:223"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="241"
--8<-- "jaclang/compiler/jac.lark:241:244"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="259"
--8<-- "jaclang/compiler/jac.lark:259:276"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="279"
--8<-- "jaclang/compiler/jac.lark:279:280"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="298"
--8<-- "jaclang/compiler/jac.lark:298:301"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="304"
--8<-- "jaclang/compiler/jac.lark:304:318"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="321"
--8<-- "jaclang/compiler/jac.lark:321:324"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="348"
--8<-- "jaclang/compiler/jac.lark:348:353"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="356"
--8<-- "jaclang/compiler/jac.lark:356:360"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="363"
--8<-- "jaclang/compiler/jac.lark:363:385"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="388"
--8<-- "jaclang/compiler/jac.lark:388:409"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="412"
--8<-- "jaclang/compiler/jac.lark:412:419"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="422"
--8<-- "jaclang/compiler/jac.lark:422:431"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="434"
--8<-- "jaclang/compiler/jac.lark:434:439"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="442"
--8<-- "jaclang/compiler/jac.lark:442:456"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="459"
--8<-- "jaclang/compiler/jac.lark:459:469"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="472"
--8<-- "jaclang/compiler/jac.lark:472:643"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
...
**Grammar Snippet**
```yaml linenums="646"
--8<-- "jaclang/compiler/jac.lark:646:657"
```
**Code Example**
=== "Jac"
    ```jac linenums="1"
